class UserAddressesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user_address.save
        format.html {redirect_to :controller => 'users', :action => 'account_info', notice: "Address #{@user_address.alias} was successfully created."}
  ...
  def update
    respond_to do |format|
      if @user_address.update(user_address_params)
        format.html {redirect_to :controller => 'users', :action => 'account_info', notice: 'User address was successfully updated.'}
  ...
  def user_address_params
    params.require(:user_address).permit(:name, :door_apartment, :locality, :city, :state, :country, :pincode, :contact, :alias, :is_home)
  end
end
