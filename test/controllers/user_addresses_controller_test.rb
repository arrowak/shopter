...
class UserAddressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_address" do
    assert_difference('UserAddress.count') do
      post user_addresses_url, params: {user_address: {alias: @user_address.alias, city: @user_address.city, contact: @user_address.contact, country: @user_address.country, door_apartment: @user_address.door_apartment, is_home: @user_address.is_home, locality: @user_address.locality, name: @user_address.name, pincode: @user_address.pincode, state: @user_address.state, user_id: @user_address.user_id}}
    end
  ...
  test "should update user_address" do
    patch user_address_url(@user_address), params: {user_address: {alias: @user_address.alias, city: @user_address.city, contact: @user_address.contact, country: @user_address.country, door_apartment: @user_address.door_apartment, is_home: @user_address.is_home, locality: @user_address.locality, name: @user_address.name, pincode: @user_address.pincode, state: @user_address.state, user_id: @user_address.user_id}}
